...
class TelaSelecaoPerguntas(tk.Canvas):
    def __init__(self, master, width=1280, height=720, highlightthickness=0):
        ...
        lista_perguntas = [
            ...
            "Pergunta 2: Quem escreveu 'Dom Casmurro'?",
            "Pergunta 3: O que é a fotossíntese?",
            "Pergunta 4: Qual é o maior planeta do sistema solar?",
            "Pergunta 5: Quem pintou a Mona Lisa?"
        ]
