...
class TelaInicial(tk.Canvas):
    def __init__(self, master, width=1280, height=720, highlightthickness=0):
        ...
        arquivo_imagem_titulo = Image.open("images/EXPEDICAO_DO_MILHAO.png").resize((750, 75), Image.LANCZOS)
        imagem_titulo = ImageTk.PhotoImage(arquivo_imagem_titulo) 

        arquivo_imagem_subtitulo = Image.open("images/HistoriaseMapas.png").resize((500, 65), Image.LANCZOS)
        ...
        arquivo_professor = Image.open('images/FrameProfessor.png').resize((300, 80), Image.LANCZOS)
        imagem_professor = ImageTk.PhotoImage(arquivo_professor)
        arquivo_aluno = Image.open('images/FrameAluno.png').resize((300, 80), Image.LANCZOS)
...
# Botão Professor
        ...
        imagem1 = self.create_image(botao_x, botao_y, image=imagem_professor, anchor='n')
        ...
        imagem2 = self.create_image(botao_x, botao2_y, image=imagem_aluno, anchor='n')
