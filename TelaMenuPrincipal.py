...
class TelaMenuPrincipal(tk.Canvas):
    def __init__(self, master, width=1280, height=720, highlightthickness=0):
        ...
        arquivo_imagem_titulo      = Image.open(r"images/EXPEDICAO_DO_MILHAO.png").resize((656, 62), Image.LANCZOS)
        imagem_titulo      = ImageTk.PhotoImage(arquivo_imagem_titulo)
        arquivo_imagem_botao1 = Image.open(r"images/Frame.png").resize((203, 58), Image.LANCZOS)
        ...
        arquivo_imagem_subtitulo    = Image.open(r"images/HistoriaseMapas.png").resize((480, 61), Image.LANCZOS)
        ...
        self.create_image(640, 200, image=imagem_titulo, anchor='n')
        self.create_image(960, 270, image=imagem_subtitulo)
        # Botão jogar
        botao_x, botao_y = 640, 200 + 62 + 15
        comprimento_botao, altura_botao = 203, 58
